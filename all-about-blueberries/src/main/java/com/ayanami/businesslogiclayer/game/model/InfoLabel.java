...
public class InfoLabel extends Label{
    ...
    public final static String FONT_PATH = "/com/ayanami/font/kenvector_future.ttf";

    public final static String BACKGROUND_IMAGE = "/com/ayanami/images/red_small_panel.png";
