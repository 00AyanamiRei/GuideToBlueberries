...
import com.ayanami.businesslogiclayer.game.model.SmallInfoLabel;
...
public class GameViewManager {
    ...
    private final static String BACKGROUND_IMAGE = "/com/ayanami/images/background.png";


    private final static String METEOR_BROWN_IMAGE = "/com/ayanami/images/garbage.png";
    private final static String METEOR_GREY_IMAGE = "/com/ayanami/images/fruit_apple_food_1815.png";
    ...
    private int points;
    private final static String GOLD_STAR_IMAGE = "/com/ayanami/images/blueberry_food_fruit_icon_182563.png";
    ...
    private void createGameElements(SHIP choosenShip) {
        ...
        pointsLabel = new SmallInfoLabel("ПОКАЗНИКИ : 00");
