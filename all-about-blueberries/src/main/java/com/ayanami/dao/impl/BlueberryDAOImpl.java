...
import com.ayanami.dao.BlueberryDAO;
import com.ayanami.model.Blueberry;
...
public class BlueberryDAOImpl implements BlueberryDAO {
    ...
    @Override
    public void save(Blueberry blueberry) {
    ...
    @Override
    public void update(Blueberry blueberry) {
    ...
    @Override
    public void delete(Blueberry blueberry) {
