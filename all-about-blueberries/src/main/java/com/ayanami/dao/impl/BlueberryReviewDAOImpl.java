...
import com.ayanami.dao.BlueberryReviewDAO;
...
public class BlueberryReviewDAOImpl implements BlueberryReviewDAO {
    ...
    @Override
    public void save(BlueberryReview review) {
    ...
    @Override
    public void update(BlueberryReview review) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
    ...
    @Override
    public void delete(BlueberryReview review) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
